...
MOMENTUM = 0.9
NUM_CLASSES = 19
RESTORE_FROM = '../ADVENT/model/DeepLab_resnet_pretrained_init-f81d91e8.pth'
...
if SOURCE == 'GTA5':
    ...
    DATA_DIRECTORY = '../ADVENT/data/GTA5'
    ...
    DATA_DIRECTORY = '../ADVENT/data/SYNTHIA/RAND_CITYSCAPES'
